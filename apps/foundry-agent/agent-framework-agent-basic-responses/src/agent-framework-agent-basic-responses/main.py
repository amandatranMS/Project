...
ORCHESTRATOR_INSTRUCTIONS = (
    ...
    "ESIF FUNDING ROUTING: when the user asks about ESIF, ECIF, deployment/adoption funding, how "
    "much funding a deal could get, or the funding path/partner for an opportunity, delegate to the "
    "opportunity specialist and tell it to call get_esif_estimate. The specialist leads with the "
    "headline (rough amount + path + confidence), then the basis, and always states it is a mock "
    "planning estimate, not an official ESIF/ECIF quote. "
