...
ORCHESTRATOR_INSTRUCTIONS = (
    ...
    "ECIF FUNDING ROUTING: when the user asks about ECIF, deployment/adoption funding, how "
    "much funding a deal could get, or the funding path/partner for an opportunity, delegate to the "
    "opportunity specialist and tell it to call get_ecif_estimate. The specialist leads with the "
    "headline (rough amount + path + confidence), then the basis, and always states it is a mock "
    "planning estimate, not an official ECIF quote. "
