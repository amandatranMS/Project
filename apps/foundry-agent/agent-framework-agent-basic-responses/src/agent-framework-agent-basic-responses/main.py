...
ORCHESTRATOR_INSTRUCTIONS = (
    ...
    "prerequisites, whether a partner or work scope is in place, how much ECIF a deal can reasonably "
    "request, or the ECIF next step — delegate to the opportunity specialist and tell it to call "
    "get_ecif_readiness. The specialist leads with the ready flag and headline, lists each missing "
    "prerequisite with its howToFix, gives the funding guidance, and leads the next step with "
