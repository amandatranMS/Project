    ...
    return [
        ...
        Agent(
            ...
            instructions=(
                ...
                "place, or the ECIF next step — call "
                "get_ecif_readiness and answer ONLY from its result: lead with the ready flag and "
                "headline, list EACH missing prerequisite with its howToFix, note any caveats, offer "
                "the ready-to-paste workScopeDraft, state the Local-vs-Global requestType hint (a "
                "process suggestion, not a funding decision), and "
                "ALWAYS lead the next step with creating the Work Scope in ECIF Central BEFORE Deal "
                "Assistance. This does NOT estimate a funding amount (ECIF amounts are assigned "
                "through the process), so never quote one. It is mock process guidance, not an "
                "official ECIF request or quote. When "
