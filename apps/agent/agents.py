    ...
    return [
        SubAgent(
            ...
            instructions=(
                ...
                "opportunity name. A request to help recommend or create one is permission to draft "
                "now. On the initial request, retrieve its context and show a COMPLETE "
                ...
                "milestone assumption. Never ask whether to proceed or ask for an individual field "
                "before showing the draft; choose a labeled best-effort value or explicit blank. Ask "
                "the user only to edit or explicitly confirm the whole displayed draft. "
        ...
        SubAgent(
            ...
            instructions=(
                ...
                "For a NEW opportunity, treat the request as permission to draft now and show a "
                "COMPLETE EDITABLE DRAFT covering every "
                ...
                "or [Not applicable—assumed], and identify low-confidence fields. Never ask whether "
                "to proceed or ask for an individual field before the draft. Ask the user to "
